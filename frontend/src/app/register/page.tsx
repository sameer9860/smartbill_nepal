      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="overflow-hidden rounded-3xl border border-white/15 bg-slate-900/80 p-8 shadow-2xl backdrop-blur-2xl sm:p-10">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-xs text-indigo-300 font-semibold bg-indigo-500/10 inline-block px-3 py-1 rounded-full border border-indigo-500/20">
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-600/30 transition duration-300 hover:from-indigo-500 hover:to-indigo-400 hover:shadow-indigo-500/40 disabled:opacity-60 mt-2"
            >
